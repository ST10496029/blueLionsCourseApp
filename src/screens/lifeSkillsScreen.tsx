  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        Fees: R1500 Purpose: To provide skills to navigate basic life
        necessities Content: Opening a bank account Basic labour law (know your
        rights) Basic reading and writing literacy Basic numeric literacy
      </Text>
      <TouchableOpacity
