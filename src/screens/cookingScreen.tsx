  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        Fees: R750 Purpose: To prepare and cook nutritious family meals Content:
        Nutritional requirements for a healthy body Types of protein,
        carbohydrates and vegetables Planning meals Tasty and nutritious recipes
