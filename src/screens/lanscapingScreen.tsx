  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        Fees: R1500 Purpose: To provide landscaping services for new and
        established gardens Content: Indigenous and exotic plants and trees
        Fixed structures (fountains, statues, benches, tables, built-in braai)
        Balancing of plants and trees in a garden Aesthetics of plant shapes and
