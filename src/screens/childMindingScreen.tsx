  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        Fees: R750 Purpose: To provide basic child and baby care Content: birth
        to six-month old baby needs seven-month to one year old needs Toddler
        needs Educational toys
      </Text>
      <TouchableOpacity
